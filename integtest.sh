...
echo "Running integ test script for orchestrator"
# npm install
...
run_remote_cypress() {
    ...
    export log_file="$log_directory/logfile.txt"
...
if [ $SECURITY_ENABLED = "true" ]; then
    ...
    echo "Cypress integration tests are disabled for Functional test repo."
    echo "Orchestrator run completes!"
else
